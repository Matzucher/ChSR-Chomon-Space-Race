...
# ~~ JK
# SOOOOOOO um never mind this, im sorry for gd script but compute shaders are a bit problematic in C#
# anyways this is pritty much useless but I aint risking breaking the project by removing it
